...
pas_data <- read_excel("~/Documents/Misc Projects/Albert_Pollen/Data/Updated_Ideas/PollenBiomarker_DATASET_ForBryan.xlsx",sheet="POS Fingerprint")
cnames_orig <- pas_data$ID
